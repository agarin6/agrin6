...
> ### My Skills:
* C#
* T-SQL (Microsoft SQL Server, Microsoft Access)
* Football skills  
* Painting skills
---
> ### Language Skills:
* English Level: A2 (According to EPAM English Test), B1 (According to A1QA English Speaking and Grammar Test)
* Russian Level: C2 (Native Speaker)
* Belarussian Level: C2 (Native Speaker)
---
